...
class LSDADataset(DeepfakeAbstractBaseDataset):
    ...
    if on_2060:
        ...
        data_list = {
            'test': r'/home/Userlist/shuhanxia/DeepfakeBench-main/datasets/FaceForensics++/test.json',
            'train': r'/home/Userlist/shuhanxia/DeepfakeBench-main/datasets/FaceForensics++/train.json',
            'eval': r'/home/Userlist/shuhanxia/DeepfakeBench-main/datasets/FaceForensics++/eval.json'
        }
